...
class KerasTextClassifier(BaseEstimator, TransformerMixin):
    ...
    def fit(self, X, y):
        ...
        self.model.fit(seqs, y, batch_size=self.bs,
...
if __name__ == "__main__":
    ...
    if not args.glove or not args.prepoc:
        ...
        text_model = KerasTextClassifier(
            args.glove, args.prepoc, epochs=1, input_length=100)
        ...
        te.fit("I kill and murder. I hate you. A very violent tweet, violence damn fuck",
